...
export const ENGLISH_BOOKS: CurriculumBook[] = [
  {
    id: "yemen-7-english-part1",
    name: "English Course - Grade 7 - Part 1.pdf",
    country: "اليمن",
    ...
    text: `Crescent English Course for Yemen - Grade 7 (Part 1) - Student Book.
Ministry of Education - Curricula and Guidance Sector.

Unit 1: Meeting People and School Life.
Lesson 1: Introductions and Greetings.
Dialogue:
- Ali: Hello! My name is Ali. What is your name?
- John: Hi Ali! I am John. I am a new teacher from England. Nice to meet you!
- Ali: Nice to meet you too, Mr. John! Welcome to Yemen.
- John: Thank you! How old are you?
- Ali: I am twelve years old. I am in the seventh grade.
Grammar: Present Simple tense of the verb "to be" (am, is, are) and basic subject pronouns (I, you, he, she, it, we, they).

Unit 2: My Family and My Home.
Lesson 1: Describing Homes and Family Members.
Reading Text: "I live in a traditional stone house in Sana'a. My grandfather, grandmother, parents, and sisters all live together. My father is an agricultural worker who grows coffee on our family farm. My mother is an English teacher at the local girl's school. We have a cozy garden where we drink tea in the afternoon."
Grammar: Possessive adjectives (my, your, his, her, our, their) and the use of "have/has" to describe relationships and possessions.

Unit 3: Daily Activities and Hobbies.
Lesson 1: Simple Daily Routines.
Reading Text: "Sami wakes up early in the morning at 5:00 AM. He performs his prayer, has breakfast with his family, and walks to school with his friends. After school, Sami enjoys reading physical books and playing football in the local park, avoiding passive screen time."
...
- Give constructive, encouraging written feedback in their notebooks to inspire their learning journey.`
  },
  {
    ...
    size: 3200000,
    uploadedAt: "2026-07-17T12:00:00Z",
    text: `Crescent English Course for Yemen - Grade 8 (Part 1) - Student Book.
Ministry of Education - Curricula and Guidance Sector.

Unit 1: Traditional Crafts and Markets.
Lesson 1: Visiting Bab Al-Yemen.
Reading Text: "Bab Al-Yemen is a famous and ancient market in the heart of Sana'a. Visitors from all over the world come to see the wonderful architecture and traditional crafts. In the market, craftsmen carve silver daggers (Janbiyah), weave beautiful textiles by hand, and roast fresh Yemeni coffee beans. The smell of cardamom and spices fills the narrow, lively alleys."
Vocabulary: Craftsmen, traditional, daggers, weave, spices, carving.
Grammar: Past Simple Tense with regular and irregular verbs (visited, came, saw, made, sold).

Unit 2: Food, Health, and Nutrition.
Lesson 1: Eating Healthy.
Reading Text: "Healthy eating is essential for a active body and mind. Traditional Yemeni meals like Salta, fresh vegetables, honey, and whole wheat bread provide the necessary energy for school and farm work. We should avoid processed fast food and carbonated drinks that cause fatigue and obesity."
Grammar: Countable and Uncountable nouns. Use of "some/any" and quantifiers like "much, many, a lot of, a few, a little".

Unit 3: Weather and Natural Wonders of Yemen.
Lesson 1: Socotra Island - The Jewel of Yemen.
Reading Text: "Socotra Island is one of the most unique natural reserves in the world. It is famous for its rare plants and trees, such as the Dragon's Blood Tree, which grows high in the mountains. The weather is warm in the winter and windy in the summer. We must protect this natural beauty from environmental pollution."
...
- Grade students on oral reading fluency, notebook neatness, and participation in pair dialogues.`
  },
  {
    ...
    size: 3300000,
    uploadedAt: "2026-07-17T12:00:00Z",
    text: `Crescent English Course for Yemen - Grade 9 (Part 1) - Student Book.
Ministry of Education - Curricula and Guidance Sector.

Unit 1: Famous Figures in History.
Lesson 1: Al-Hasan Al-Hamdani - The Yemeni Scholar.
Reading Text: "Al-Hasan Al-Hamdani was an extraordinary Yemeni geographer, historian, and astronomer who lived in the 10th century. He wrote the famous book 'Sifat Jazirat al-Arab' (The Description of the Arabian Peninsula), which details the geography, tribes, and natural resources of the region. He spent his life travelling on foot and on horseback, observing and documenting the real physical world rather than speculating from far away."
Vocabulary: Geographer, astronomer, peninsulas, travel, document, resources.
Grammar: Past Continuous tense vs. Past Simple (e.g., "While he was travelling, he met many scholars").

Unit 2: Science, Technology, and Future Vocations.
Lesson 1: Future Jobs and Careers.
Reading Text: "As students prepare to complete their basic education, they think about their future careers. Yemen needs dedicated engineers to build water dams, doctors to serve rural villages, computer programmers to design local software, and teachers to educate the next generation. Hard work, integrity, and lifelong study are the keys to a prosperous future."
Grammar: Expressing future plans and predictions using "going to" vs. "will".

Unit 3: Environment and Water Conservation.
